...
>
> *(Traducción: Eres un asistente de IA para gastos corporativos. Respondes preguntas sobre gastos basándote en los datos de la política de gastos. Si un usuario quiere enviar una reclamación de gastos, obtienes su dirección de correo electrónico, una descripción de la reclamación y el monto a reclamar, y escribes los detalles de la reclamación en un archivo de texto que el usuario puede descargar.)*
...
Para que el agente pueda *hacer* algo (en este caso, generar un archivo de reclamación), añadimos la herramienta **Intérprete de código (Code interpreter)**.
...
1.  **Consulta de Política:**
    Preguntamos: *"What's the maximum I can claim for meals?"* (¿Cuál es el máximo que puedo reclamar por comidas?).
    *   **Resultado esperado:** El agente busca en el documento de política cargado y responde con la información correcta.

2.  **Acción Compleja:**
    Indicamos: *"I'd like to submit a claim for a meal."* (Me gustaría enviar una reclamación por una comida.).
